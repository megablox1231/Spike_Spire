...
public class PlayerMovement : MonoBehaviour {
	...
	public void OnJumpInputDown() {
		if (controller.jumpCollider.IsTouchingLayers(controller.deadlySBMask)) {
    ...
    public void OnForwardSlashInputDown() {
        if (controller.slashCollider.IsTouchingLayers(controller.deadlySBMask)) {
            GameMaster.KillPlayer(gameObject);
        }
