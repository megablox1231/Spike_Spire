...
/// Extras: slopes, one-way platforms
/// </summary>
public class Controller2D : RaycastController {
	...
	void VerticalCollisions(ref Vector2 moveAmount) {
		...
		for (int i = 0; i < verticalRayCount; i ++) {
			...
			if (hit) {
				...
				collisions.below = directionY == -1;    //if moving down
				collisions.above = directionY == 1;     //if moving up
			}
		}
    ...
    void UpdateDirectionFaced() {
		...
		jumpCollider.transform.localPosition = (collisions.faceDir == 1) ? new Vector3(0.1555f, jumpCollider.transform.localPosition.y, jumpCollider.transform.localPosition.z)
												: new Vector3(-0.1555f, jumpCollider.transform.localPosition.y, jumpCollider.transform.localPosition.z);
		collider.transform.localPosition = (collisions.faceDir == 1) ? new Vector3(- 0.0059f, collider.transform.localPosition.y, collider.transform.localPosition.z)
												: new Vector3(-0.25f, collider.transform.localPosition.y, collider.transform.localPosition.z);
